...
static int emac_ptp_sysfs_mode_show(
	struct device *dev,
	struct device_attribute *attr,
	char *buf)
{
...
static int emac_ptp_sysfs_mode_set(
	struct device *dev,
	struct device_attribute *attr,
	const char *buf,
	size_t count)
...
static int emac_ptp_sysfs_frac_ns_adj_show(
	struct device *dev,
	struct device_attribute *attr,
	char *buf)
{
...
static int emac_ptp_sysfs_frac_ns_adj_set(
	struct device *dev,
	struct device_attribute *attr,
	const char *buf,
	size_t count)
